...
import type { getTweetLikedByTool } from "./base";
...
export const getTweetLikedByToolConfigClient: ClientToolConfig<
...
> = {
  ...
  ResultComponent: ({ result, append }) => {
    if (!result.users.length) {
      return (
        <div className="text-muted-foreground text-sm">No likes found</div>
      );
    }
