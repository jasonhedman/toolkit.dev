...
export const getTweetLikedByTool = createBaseTool({
  description:
    "Get a list of users who have liked a specific tweet. Returns user profiles of those who liked the tweet.",
  inputSchema: z.object({
    tweet_id: z
      .string()
      .describe("The unique identifier of the tweet"),
    max_results: z
      .number()
      .min(1)
      .max(100)
