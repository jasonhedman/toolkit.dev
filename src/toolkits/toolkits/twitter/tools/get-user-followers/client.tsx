...
import type { getUserFollowersTool } from "./base";
...
export const getUserFollowersToolConfigClient: ClientToolConfig<
...
> = {
  ...
  ResultComponent: ({ result, append }) => {
    if (!result.followers.length) {
      return (
        <div className="text-muted-foreground text-sm">No followers found</div>
      );
    }
