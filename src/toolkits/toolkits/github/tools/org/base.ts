...
export const orgDataTool = createBaseTool({
  description:
    "Get information about a GitHub organization including repositories",
  inputSchema: z.object({
    org: z
      .string()
      .describe("The GitHub organization name to get information for"),
  }),
  outputSchema: z.object({
    organization: z.object({
      ...
      location: z
        .string()
        .nullish()
        .describe("The location of the organization"),
      email: z.string().nullish().describe("The email of the organization"),
      blog: z
        .string()
        .nullish()
        .describe("The blog/website of the organization"),
      twitter_username: z
        .string()
        .nullish()
        .describe("The Twitter username of the organization"),
      ...
      .array(
        z.object({
          ...
          language: z
            .string()
            .nullish()
            .describe("The primary language of the repository"),
